...
public class Lucene {
    ...
    String pathToQueryList = "QueryList.txt";
    ...
    File folderSetup = new File("Lucene Evaluations");
        ...
        if (pointerToQueries.exists()) {
            try {
                ...
                while (fileContent.hasNextLine()) {
                    ...
                    int maxResults = Math.min(100, hits.length);
                    try {
                        outputStream = new FileWriter("Lucene Evaluations/Q" + query_ID + ".txt");
                        String builder = "";
                     // 4. display results
                        for (int i = 0; i < maxResults; i++) {
                            ...
                            // Output: Query_ID Q0 fileName Rank score Lucene
                            builder += query_ID + " Q0 " + fileName + " "
